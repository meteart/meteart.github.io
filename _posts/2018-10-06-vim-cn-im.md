...
Update: 我咋弄两个APP inventor 配置？

---

我相信很多同学都想开发自己的APP程序在我们班级中我统计的很多的数据，输完之后会本能的直接 `esc` 接 normal 模式操作，结果发现跳出来的是中文输入法……对于 vscode，我一般会在几次错误之后被逼到退出 vscode vim 模式，而对于终端中用的 neovim，就只能尽量不输入中文了。
